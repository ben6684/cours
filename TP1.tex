...
\begin{figure}[!h]
\includegraphics[width=15cm]{tp1_exo1_val.png} 
...
\begin{figure}[!h]
\includegraphics[width=15cm]{tp1_exo1_key.png} 
%\caption{Map, sort step with output of sorting step for the value oriented solution} 
...
Indication : ici, on reprend l'exercice 1 et on ajoute un filtrage sur les lignes et non plus les colonnes. Pour cela deux choix s'offrent à vous ... 
